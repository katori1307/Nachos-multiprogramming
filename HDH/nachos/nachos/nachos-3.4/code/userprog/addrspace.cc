...
AddrSpace::AddrSpace(OpenFile *executable)
{
    ...
    // check whether file is able to be opened.
    if(executable == NULL)
    {
	printf("\n\nAddrspace:: Error opening file");
	return;
    }
    ...
    addrLock->P(); // variable and method from Semaphore class :) (which was built before in synch.h). 
...
// first, set up the translation 
	...
	//pageTable[i].physicalPage = i;  // needs to fix this for multi-program
